...
// Source: github.com/ozoncp/ocp-vacancy-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []models.Vacancy) []models.Vacancy {
	m.ctrl.T.Helper()
